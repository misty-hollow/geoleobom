...
갱신: 2026-09-13 (Week 3 web production 배포 완료, 게이트 2 한국 내 응답시간 실측). 운영 변화·주간 정리·막힘·중단/인계 때 갱신한다.
...
- **현재 작업: 없음. Week 3 production 배포가 끝났다 (2026-09-13, Opus 5).**
...
- main `9212bcf95fd624aff66729c1b54244ceed1d9607` (2026-09-13 확인). **현재 기준 문서는 `docs/걸어봄_확정설계_v2.4.md`다.**
  - 역사: PR #15 병합 시점의 main은 `63467d78…`이었고 그때 기준 문서는 v2.3이었다.
