...
갱신: 2026-09-15 (Week 4 구현 진행 — 검색·경로 UX·세션 장소명 병합, 비교표 §14 Draft PR). 운영 변화·주간 정리·막힘·중단/인계 때 갱신한다.
