...
`far`는 경계 바깥(≥800m)에 둔다. 우회가 있어도 near는 안, far는 밖에 남는다.

- `capped`: near ≥ 25 → 첫 배치에서 20곳을 채워 즉시 종료(`20+`).
...
# 10분 경계(보행 750m)를 사이에 두고 확실히 갈라놓는다.
DENSITY_NEAR_MIN_M = 90.0
DENSITY_NEAR_MAX_M = 350.0
DENSITY_FAR_MIN_M = 800.0
DENSITY_FAR_MAX_M = 980.0
